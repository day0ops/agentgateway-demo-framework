...
export class BudgetManagementFeature extends Feature {
  ...
  async deployInfrastructure() {
    ...
    try {
      await execAsync('make deploy-budget-management', {
        cwd: process.cwd(),
  ...
  async deployWithKubectl() {
    ...
    const postgresPath = `${projectRoot}/extras/budget-management/deploy/postgres.yaml`;
    ...
    const deploymentPath = `${projectRoot}/extras/budget-management/deploy/deployment.yaml`;
