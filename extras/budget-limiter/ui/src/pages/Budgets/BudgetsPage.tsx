...
export function BudgetsPage() {
  ...
  const { data: budgets, loading, refresh } = useApi(
    useCallback(() => budgetsApi.list(), [])
  );

  const createMutation = useMutation(budgetsApi.create);
  const updateMutation = useMutation(
    useCallback((id: string, data: UpdateBudgetRequest) =>
  ...
  return (
    <Container>
      <PageHeader
        title="Budgets"
        description="Manage budget definitions and track usage"
      >
            ...
            <TableBody>
              {buildBudgetTree(budgets).map(({ budget, depth, isLast }) => (
                ...
                >
                  ...
                  <TableCell>
                    {budget.enabled ? (
                      <Badge variant={getStatusVariant(budget)}>
                  ...
                  <TableCell align="right">
                    <ActionButtons>
                      ...
                      <ActionButton onClick={(e) => handleEdit(budget, e)}>
                        Edit
                      </ActionButton>
