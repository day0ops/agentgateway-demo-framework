...
export function ModelCostForm({
  ...
  const handleChange = (field: keyof CreateModelCostRequest, value: string | number | undefined) => {
        ...
        <Row>
          ...
          >
            <Input
              ...
              onChange={(e) => handleChange('input_cost_per_million', parseFloat(e.target.value) || 0)}
              required
            />
          </FormField>
          <FormField
          ...
          >
            <Input
              ...
              onChange={(e) => handleChange('output_cost_per_million', parseFloat(e.target.value) || 0)}
              required
            />
          </FormField>
        </Row>
        <Row>
          ...
          >
            <Input
              ...
              onChange={(e) => handleChange('cache_read_cost_million', parseFloat(e.target.value) || undefined)}
          ...
          >
            <Input
              ...
              onChange={(e) => handleChange('cache_write_cost_million', parseFloat(e.target.value) || undefined)}
              placeholder="Optional"
            />
          </FormField>
        </Row>
